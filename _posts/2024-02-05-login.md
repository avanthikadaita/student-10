...
<body>
  <div class="container">
    ...
    <p style="text-align: center; margin-top: 20px;">Don't have an account? <a href="http://127.0.0.1:4100/Nighthawk-Pages/" style="color: #007bff; text-decoration: none;">Sign Up</a></p>
  </div>
      ...
      fetch("http://127.0.0.1:8086/api/users/authenticate", requestOptions)
        .then(response => {
          if (response.ok) {
            ...
            window.location.href = "http://127.0.0.1:4100/Nighthawk-Pages/"
          } else {
